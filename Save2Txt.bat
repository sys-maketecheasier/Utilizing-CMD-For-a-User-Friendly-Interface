...
set /p t2a2=Line 2: 
set /p t2a3=Line 3: 
echo %t2a1% >> C:\Users\%USERPROFILE%\Desktop\Save2Txt.txt
echo %t2a2% >> C:\Users\%USERPROFILE%\Desktop\Save2Txt.txt
echo %t2a3% >> C:\Users\%USERPROFILE%\Desktop\Save2Txt.txt
